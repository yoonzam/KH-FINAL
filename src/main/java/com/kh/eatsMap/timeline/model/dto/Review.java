...
public class Review {
	...
	private String[] hashtag;	//md01(친근),md02(고급),md03(가족),md04(데이트),md05(혼밥),md06(회식),pr01(가성비),pr02(가심비), pr03(1~2만원대), pr04(2~3만원대), pr04(3만원 이상)
